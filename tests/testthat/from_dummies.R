...
test_that("from_dummies works as expected", {
  newdf <- from_dummies(example_df, x, a, b)
...
test_that("from_dummies_.tbl_df works", {
  newdf <- from_dummies_(tbl_df(example_df), "x", a, b)
